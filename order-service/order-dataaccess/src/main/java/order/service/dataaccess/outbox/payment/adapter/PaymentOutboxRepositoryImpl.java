package order.service.dataaccess.outbox.payment.adapter;

import org.springframework.stereotype.Component;
import order.service.dataaccess.outbox.payment.exception.PaymentOutboxNotFoundException;
import order.service.dataaccess.outbox.payment.mapper.PaymentOutboxDataAccessMapper;
import order.service.dataaccess.outbox.payment.repository.PaymentOutboxJpaRepository;
import order.service.domain.outbox.model.payment.OrderPaymentOutboxMessage;
import order.service.domain.ports.output.repository.PaymentOutboxRepository;
