package order.service.dataaccess.outbox.restaurantapproval.adapter;

import org.springframework.stereotype.Component;
import order.service.dataaccess.outbox.restaurantapproval.exception.ApprovalOutboxNotFoundException;
import order.service.dataaccess.outbox.restaurantapproval.mapper.ApprovalOutboxDataAccessMapper;
import order.service.dataaccess.outbox.restaurantapproval.repository.ApprovalOutboxJpaRepository;
import order.service.domain.outbox.model.approval.OrderApprovalOutboxMessage;
import order.service.domain.ports.output.repository.ApprovalOutboxRepository;
